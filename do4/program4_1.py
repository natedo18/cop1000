...
#start accumulator assigning total to 0
#start while expression ticket price!=0
...
#use float in case an item is not a whole dollar
    price=float(input('Enter the ticket price of the item or 0 to quit: '))
    while price!=0:
...
#printing all required information                         
        ...
        print('Item subtotal: $',format(subtotal,'.2f'),sep='')   
        price=float(input('Enter the ticket price of item or 0 to quit: '))
        total+=subtotal
